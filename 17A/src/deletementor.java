 ...
 * @author HOME
 */
public class deletementor extends javax.swing.JFrame {

    /**
     * Creates new form deletementor
     */
    public deletementor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Delete Mentor Information");
 ...
 try
        { Class.forName("java.sql.Driver");
            ...
            String sql = "delete from mentor where mentor_id ="+id;
            int resp=JOptionPane.showConfirmDialog(null,"do you really want to delete this record ?");
            if(resp==0)
...
this.dispose();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(deletementor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new deletementor().setVisible(true);
            }
        });
    }
